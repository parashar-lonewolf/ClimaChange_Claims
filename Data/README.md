...
and [This](./4mFullData_NYT_KyotoConferenceData_cleaned.txt) will be used by [the Annotator](./ClimaChange_Claims/ACTOR_CLAIM_ANNOTATOR.py)
to create the ConLL and claim files in the [Save](./ClimaChange_Claims/Save) folder
